...
<html lang="en">
    ...
    <head>
        ...
        <title>Programming Language || Programming languages</title>
                ...
                <div class="container-fluid">
                        ...
                        <div class="col-md-8">
                            <nav aria-label="breadcrumb" class="align-items-center">
                                ...
                                <ol class="breadcrumb d-none d-lg-inline-flex m-0">
                                    ...
                                    <li class="breadcrumb-item active" aria-current="page">Programming languages</li>
                                </ol>
                            </nav>
                        </div>
                    </div>
                    <div class="row ml-lg-2 mr-lg-1">
                        <article class="main-content col-lg-12 col-md-12 col-xs-12">
                            <h1 class="mb-2 mt-3">Programming languages</h1>
                            <p class="float-right">
                               The universe of programming languages is wide and knowing all or learning each one of them is neither practical nor possible. If you are a developer who is interested in learning the most useful and popular ones, then you must first know which ones of the thousands of languages to learn. The list of the commonly used programming languages are given below, and it is clear that JavaScript is the most popular followed closely by Java, Python, and others.
                                <ol>
                                    <li>HTML</li>
                                    <li>CSS</li>
                                    <li>JavaScript</li>
