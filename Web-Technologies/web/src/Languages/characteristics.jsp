...
<html lang="en">
    ...
    <head>
        ...
        <title>Programming Language || The characteristics of a programming language</title>
                ...
                <div class="container-fluid">
                        ...
                        <div class="col-md-8">
                            <nav aria-label="breadcrumb" class="align-items-center">
                                ...
                                <ol class="breadcrumb d-none d-lg-inline-flex m-0">
                                    ...
                                    <li class="breadcrumb-item active" aria-current="page">The characteristics of a programming language</li>
                                </ol>
                            </nav>
                        </div>
                    </div>
                    <div class="row ml-lg-2 mr-lg-1">
                        <article class="main-content col-lg-12 col-md-12 col-xs-12">
                            <h1 class="mb-2 mt-3">The characteristics of a programming language</h1>
                            <p class="float-right">
