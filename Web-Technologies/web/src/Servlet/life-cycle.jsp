                ...
                <div class="container-fluid">
                        ...
                        <div class="col-md-8">
                            <nav aria-label="breadcrumb" class="align-items-center">
                                ...
                                <ol class="breadcrumb d-none d-lg-inline-flex m-0">
                                    ...
                                    <li class="breadcrumb-item active" aria-current="page">Life Cycle</li>
                                </ol>
                            </nav>
                        </div>
                    </div>
                    <div class="row ml-lg-2 mr-lg-1">
                        <article class="main-content col-lg-12 col-md-12 col-xs-12">
                            <h1 class="mb-2 mt-3">Servlet Life Cycle</h1>
                            <p class="float-right">
                                A servlet life cycle can be defined as the entire process from its creation till the destruction. ... The servlet is initialized by calling the init() method. The servlet calls service() method to process a client's request. The servlet is terminated by calling the destroy() method
                            </p>
                            <img class="col-lg-6 col-xs-6 img-fluid border" src="${pageContext.request.contextPath}/img/servlet-2.png"/>    
                            
                            <hr class="my-5">
                            
                            <h3 class="mb-2 mt-3"> Who maintains life cycle of servlet? </h3>
                            <p>
                            ...
                            <p>
                                ...
                                <ol>
                                    <li>This method uses ServletRequest object to collect the data requested by the client.</li>
                                    <li>This method uses ServletResponse object to generate the output content.</li>
                                </ol>
                            </p>
                        </article>
                    </div>
